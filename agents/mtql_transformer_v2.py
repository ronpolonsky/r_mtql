"""MTQL transformer V2, forked from the base agent for real-robot integration."""
...
class MTQLTransformerV2Agent(flax.struct.PyTreeNode):
    rng: Any
    network: Any
...
def get_config():
    config = ml_collections.ConfigDict(dict(
        agent_name='mtql_transformer_v2',
