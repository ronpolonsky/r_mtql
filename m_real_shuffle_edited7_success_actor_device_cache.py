#!/usr/bin/env python3
"""Edited7 Shuffle success-actor trainer with virtual cue history.

This entry point is intentionally explicit about the edited7 contract:
seven initial cue observations are expanded in history-index space, while
the validated Egg-shaped transition cache remains unchanged.
"""
...
FLAGS.set_default("project", "real_shuffle_v2_edited7_success_actor")
FLAGS.set_default("wandb_run_group", "shuffle_v2_edited7_success_actor")
...
def main(argv):
    ...
    return m_real_success_actor.main([sys.argv[0]])
