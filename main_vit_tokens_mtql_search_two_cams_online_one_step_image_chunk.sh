...
# python collect_cabinet_dataset.py --num-episodes 200 --output-dir ./cabinet_dataset_two_cams_more_rand --visualize --seed 42 --image-size 128 --num-expert 0 --num-noisy 250 --randomize-cabinet-pose

python m_main.py --env_name=search_cabinet_two_cams_more_rand --train_steps=2000000 --agent=agents/mtql_transformer.py --agent.critic_grad_clip=100.0 --agent.alpha=300 --agent.attention_entropy_target="((4.5, 4.5), (4.0, 4.0))" --agent.hidden_dim=128 --hist_length=12 --log_interval=10 --agent.tokenization_mode=per_modality  --num_eval_envs=1 --eval_interval=20000 --eval_episodes=50 --video_episodes=0 --video_frame_skip=2 --hist_stride=50 --single_step_online --online_warmup_steps=100000 --image_obs --agent.batch_size=32 --save_interval=10000 --agent.encoder=mem_vit_tokens_small --num_cached_episodes 20 --video_episodes 2 --action_chunk_size 25 --action_exec_horizon 25 --online_buf_size 500000 --visualize_online  --nolazy_dataset
